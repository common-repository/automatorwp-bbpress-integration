...
class AutomatorWP_bbPress_Create_Forum extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User creates a forum', 'automatorwp-bbpress-integration' ),
            'select_option'     => __( 'User creates <strong>a forum</strong>', 'automatorwp-bbpress-integration' ),
            /* translators: %1$s: Number of times. */
            'edit_label'        => sprintf( __( 'User creates a forum %1$s time(s)', 'automatorwp-bbpress-integration' ), '{times}' ),
            'log_label'         => __( 'User creates a forum', 'automatorwp-bbpress-integration' ),
