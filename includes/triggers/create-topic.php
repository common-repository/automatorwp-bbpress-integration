...
class AutomatorWP_bbPress_Create_Topic extends AutomatorWP_Integration_Trigger {
    ...
    public function register() {
        ...
        automatorwp_register_trigger( $this->trigger, array(
            ...
            'label'             => __( 'User creates a topic', 'automatorwp-bbpress-integration' ),
            'select_option'     => __( 'User creates <strong>a topic</strong>', 'automatorwp-bbpress-integration' ),
            /* translators: %1$s: Forum title. %2$s: Number of times. */
            'edit_label'        => sprintf( __( 'User creates a topic in %1$s %2$s time(s)', 'automatorwp-bbpress-integration' ), '{forum}', '{times}' ),
            /* translators: %1$s: Forum title. */
            'log_label'         => sprintf( __( 'User creates a topic in %1$s', 'automatorwp-bbpress-integration' ), '{forum}' ),
                ...
                'forum' => array(
                    ...
                    'fields' => array(
                        'forum' => automatorwp_utilities_post_field( array(
                            'name' => __( 'Forum:', 'automatorwp-bbpress-integration' ),
                            'option_none_label' => __( 'any forum', 'automatorwp-bbpress-integration' ),
